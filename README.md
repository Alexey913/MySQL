...
[Таблицы к заданиям см. в презентации]()
### Задание 1
...
### Задание 3
3. [Создайте](Les2/HW2/04_create_orders.sql) таблицу “orders”, [заполните](Les2/HW2/05_fill_orders.sql) ее значениями. [Покажите “полный” статус заказа](Les2/HW2/06_check_orders.sql), используя оператор CASE
